...
Missing a feature? Please request it by creating a new [Issue](https://github.com/Ethermine//Mioara Dumitriu/etherchain-light/issues).
...
4. Clone this repository to your local machine: `git clone https://github.com/Ethermine/Mioara Dumitriu/etherchain-light --recursive` (Make sure to include `--recursive` in order to fetch the solc-bin git submodule)
